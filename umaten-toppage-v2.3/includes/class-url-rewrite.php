<?php
/**
 * URLリライトルールクラス (v2.3.0 投稿表示機能の実装)
 * 投稿を検出したら積極的に表示する
 */
...
class Umaten_Toppage_URL_Rewrite {
    ...
    public function handle_404_redirect() {
        ...
        // 【v2.3.0 重要改善】投稿の存在を厳密にチェックし、見つかったら表示する
        // 2段階URL（/親/投稿名/）の場合
        if (count($parts) == 2) {
    ...
    /**
     * 【v2.3.0 新機能】投稿ページとして表示するクエリをセットアップ
     *
