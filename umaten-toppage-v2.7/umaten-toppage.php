 ...
 * Description: 動的なカテゴリ・タグ表示を備えたトップページ用プラグイン。全エリア対応の3ステップナビゲーション（親→子カテゴリ→ジャンル）。SEO最適化・URLリライト完全修正・ヒーロー画像メタデータ保存（SWELLテーマ完全対応）。検索結果ページ対応（モダンUI）。独自アクセスカウント機能搭載。投稿とカテゴリの完全な区別。記事ページ表示完全修正。
 * Version: 2.7.0
 * Author: Umaten
...
// プラグインの定数定義
define('UMATEN_TOPPAGE_VERSION', '2.7.0');
