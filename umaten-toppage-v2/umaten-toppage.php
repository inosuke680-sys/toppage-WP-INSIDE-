 ...
 * Description: 動的なカテゴリ・タグ表示を備えたトップページ用プラグイン。全エリア対応の3ステップナビゲーション（親→子カテゴリ→ジャンル）。SEO最適化・URLリライト完全改善・アイキャッチ画像自動設定。検索結果ページ対応（モダンUI）。独自アクセスカウント機能搭載。投稿とカテゴリの完全な区別。
 * Version: 2.0.0
 * Author: Umaten
...
// プラグインの定数定義
define('UMATEN_TOPPAGE_VERSION', '2.0.0');
