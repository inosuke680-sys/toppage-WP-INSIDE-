 ...
 * Description: 動的なカテゴリ・タグ表示を備えたトップページ用プラグイン。全エリア対応の3ステップナビゲーション（親→子カテゴリ→ジャンル）。SEO最適化・URLリライト完全修正（多重ハンドリング実装）・ヒーロー画像自動設定機能（6パターン画像抽出・5方法attachment ID取得・外部画像インポート対応・SWELL完全対応）。検索結果ページ対応（モダンUI）。独自アクセスカウント機能搭載。投稿とタグの完全な区別。完全なデバッグログシステム・多重エラーハンドリング。
 * Version: 2.10.0
 * Author: Umaten
...
// プラグインの定数定義
define('UMATEN_TOPPAGE_VERSION', '2.10.0');
